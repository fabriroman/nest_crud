import { Body, Controller, Delete, Get, Param, Post, Patch, HttpCode, HttpStatus } from '@nestjs/common';
...
export class SocialMediaForUserController {
    ...
    @Get()
    async getSocialMediasByUser(@Param('userId', PositiveIntPipe) userId: number): Promise<ResponseSocialMediaDto[]> {
    ...
    async updateSocialMediaForUser(
        ...
        return this.socialMediaService.updateByUser(userId, id, updateSocialMediaDto);
    }
